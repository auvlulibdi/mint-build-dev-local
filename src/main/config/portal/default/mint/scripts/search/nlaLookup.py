...
from com.googlecode.fascinator.redbox.sru import ExtNLAIdentity
...
class NlaLookupData:
    ...
    def searchNla(self):
        ...
        identities = ExtNLAIdentity.convertAllNodesToIdentities(response.getResults(), False)		
        ...
        for id in identities:
            ...
            idEntry.put("additionalInfo", id.getAdditionalInformation())			
            idEntry.put("otherId", id.getOtherId())						
            knownIds = JSONArray()
